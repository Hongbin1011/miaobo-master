...
import com.anzhuo.video.app.dongtu.utils.ActivityManager;
 ...
 */
public abstract class DongtuBaseActivity extends AppCompatActivity implements View.OnClickListener {
...
//    public Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = DongtuBaseActivity.this;
...
//        JCVideoPlayer.releaseAllVideos();
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == this.getResources().getConfiguration().ORIENTATION_PORTRAIT) {
            Logger.i("竖屏");
            full(false);
        } else if (newConfig.orientation == this.getResources().getConfiguration().ORIENTATION_PORTRAIT) {
            Logger.i("横屏");
            full(true);
        }
