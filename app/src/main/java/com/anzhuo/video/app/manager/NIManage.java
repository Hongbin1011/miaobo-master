...
//    }
     ...
     * @param myInterface
     */
    public static void Search(String category, String page, String limit, final MyInterface myInterface) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("category", category);
        hashMap.put("page", page);
        hashMap.put("os", "1");
        hashMap.put("version", PackageUtil.getVersionName(VideoApplication.getContext()));
        initHttp(AppServerUrl.ITEM_SEARCH_2, hashMap, myInterface);
    }
...
*/
     ...
     * @param myInterface
     */
    public static void getAdState(final MyInterface myInterface) {
        HashMap<String, String> hashMap = new HashMap<>();
        initHttp(AppServerUrl.ADVERT_ADVERTSTATUS, hashMap, myInterface);
    }
