package com.anzhuo.video.app.search.load;
...
public class ImageLoaderManager {
    ...
    public static void displayImageByUrl(Context context, final ImageView imageView, String url) {
        ...
        displayImageByUrl(context, imageView, url, 0);
    }
     ...
     * @param drawableId
     */
 /*   public static void displayImageByUrlDetail(final Context context, ImageView imageView,
                                               final CircleProgressBar pb, String url, int drawableId) {
        Glide.with(context)
                .load(url)
                .override(Target.SIZE_ORIGINAL, Target.SIZE_ORIGINAL)
                .thumbnail(1f)
     ...
     * @param url
     */
   /* public static void displayImageByUrl(final Context context, final ImageView imageView,
...
//                .placeholder(defultImage[defultPosition])
                .into(new GlideDrawableImageViewTarget(imageView) {
                    @Override
                    public void onLoadFailed(Exception e, Drawable errorDrawable) {
                        super.onLoadFailed(e, errorDrawable);
//                        ViewUtil.setViewBackground(imageView,errorDrawable);
                        ViewUtil.gone(pb);
