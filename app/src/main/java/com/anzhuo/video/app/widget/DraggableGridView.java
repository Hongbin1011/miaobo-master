...
//    ExerciseHandler handler=new ExerciseHandler(this);
...
//        handler.postAtTime(updateTask, SystemClock.uptimeMillis() + 500);
        weakHandler.removeCallbacks(updateTask);
        weakHandler.postAtTime(updateTask,SystemClock.uptimeMillis()+500);
...
//        private SoftReference<DraggableGridView> softReference = null;
//
//        public ExerciseHandler(DraggableGridView draggableGridView) {
//            softReference = new SoftReference<DraggableGridView>(draggableGridView);
//        }
//        @Override
//        public void handleMessage(Message msg) {
//            DraggableGridView draggable=softReference.get();
//            if(null!=draggable)
//            {
...
//            handler.postDelayed(this, 25);
            weakHandler.postDelayed(this,25);
        }
    };
