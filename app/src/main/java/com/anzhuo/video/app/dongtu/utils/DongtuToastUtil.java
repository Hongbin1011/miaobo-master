...
//    private static Handler baseHandler=new MyInnerHandler(t);
    ...
    static class MyInnerHandler extends Handler {
        ...
        MyInnerHandler(DongtuToastUtil aFragment) {
            mFrag = new WeakReference<DongtuToastUtil>(aFragment);
        }

        @Override
        public void handleMessage(Message msg) {
            DongtuToastUtil theFrag = mFrag.get();
            switch (msg.what) {
                case SHOW_TOAST:
...
//    }
    ...
    public static void showCustomToast(String toastString) {
        float viewHeight = mContext.getResources().getDimension(R.dimen.dongtu_tab_height) + mContext.getResources().getDimension(R.dimen.tab_layout_height);
    ...
    public static void showCustomToast(String toastString, int height) {
        ...
        LinearLayout.LayoutParams layoutParams =
                new LinearLayout.LayoutParams(DisplayUtil.getScreenWidth(mContext), LinearLayout.LayoutParams.WRAP_CONTENT);
