/*
package com.anzhuo.video.app.manager.fuli.x5blink;
...
public class X5WebView extends WebView {
    ...
    TextView title;
    private X5WebviewScrollListener onX5WebviewScrollListener;

    public void setOnX5WebviewScrollListener(X5WebviewScrollListener mListener) {
        this.onX5WebviewScrollListener = mListener;
    }
...
//            Log.i("yuanhaizhou", "webpage title is " + arg1);
    ...
    private void initWebViewSettings() {
        ...
        webSetting.setCacheMode(NetUtil.isNetworkEnable(getContext()) ? WebSettings.LOAD_DEFAULT : WebSettings.LOAD_CACHE_ELSE_NETWORK);
...
//        android.util.Log.d("Bran", "dispatchTouchEvent " + ev.getAction() + " " + r);
    ...
    public void tbs_onScrollChanged(int l, int t, int oldl, int oldt, View view) {
        if(onX5WebviewScrollListener!=null)
            onX5WebviewScrollListener.onScrollChanged(l,t,oldl, oldt, view);
    ...
    protected void tbs_onOverScrolled(int scrollX, int scrollY, boolean clampedX, boolean clampedY, View view) {
        ...
        if(onX5WebviewScrollListener!=null)
            onX5WebviewScrollListener.onOverScrolled(scrollX, scrollY, clampedX, clampedY, view);
    ...
    public interface X5WebviewScrollListener{
