...
import com.anzhuo.video.app.manager.fuli2.GameDetailFragment2;
import com.anzhuo.video.app.manager.fuli2.SearchFragment2;
import com.anzhuo.video.app.manager.fuli2.X5WebViewFragment;

*/
/**
 * Created with Android Studio.
 * Authour：Eric_chan
 * Date：2016/9/29 09:57
 * Des：
 *//*
...
public class FragmentFactory {
    ...
    public BaseFragment getFragment(int type, boolean useCache) {
        ...
        switch (type) {
            case FragmentFactory.FRAGMENT_TYPE_RECOMMEND:
