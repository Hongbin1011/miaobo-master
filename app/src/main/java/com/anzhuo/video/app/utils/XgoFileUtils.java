...
public class XgoFileUtils {
	...
	private static final String ROOT_DIR = "camera_xgo";


	public static String getPicDir() {
		return getDir("pic_xgo");
	}
	...
	public static String getVideoSmailDir(){
		return getDir("joke_wrap"+File.separator+"smail");
	}
	...
	private static String getDataDir(String string) {
		// data/data/包名/cache
		String path = VideoApplication.getInstance().getCacheDir().getAbsolutePath()+File.separator+string;
