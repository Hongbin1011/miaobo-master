...
public class MultiStateView extends FrameLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.kMultiStateView);
        mLoadingViewResId = a.getResourceId(R.styleable.kMultiStateView_loadingView, -1);
        mEmptyViewResId = a.getResourceId(R.styleable.kMultiStateView_emptyView, -1);
        mErrorViewResId = a.getResourceId(R.styleable.kMultiStateView_errorView, -1);
        mNetworkErrorViewResId = a.getResourceId(R.styleable.kMultiStateView_networkErrorView, -1);
        int viewState = a.getInt(R.styleable.kMultiStateView_viewState, VIEW_STATE_CONTENT);
    ...
    public void setViewState(@ViewState int state) {
        if (state != mViewState || getView(mViewState) == null) {
            mViewState = state;
            setView();
        }
    }
    ...
    private void setView() {
        switch (mViewState) {
            case VIEW_STATE_LOADING:
                ...
                if (mNetworkErrorView != null) mNetworkErrorView.setVisibility(View.INVISIBLE);
            ...
            case VIEW_STATE_EMPTY:
                ...
                if (mLoadingView != null) mLoadingView.setVisibility(View.INVISIBLE);
                if (mErrorView != null) mErrorView.setVisibility(View.INVISIBLE);
                if (mNetworkErrorView != null) mNetworkErrorView.setVisibility(View.INVISIBLE);
                if (mContentView != null) mContentView.setVisibility(View.INVISIBLE);
                break;
