...
//    }
     ...
     * 收藏添加事件
     */
    public static class EnventCollectAdd {
     ...
     * 取消添加事件
     */
    public static class EnventCollectCancel {
        public static String collectId;
    }

    public static class EnventAd {
    }

    //通知弹出登录pop
    public static class EnventLogin {
        public static boolean toLogin;
    }
    //加入vip通知弹出pop
    public static class EnventJoinVip {
        public static String toJoin;
    }

    //vip续费通知弹出pop
    public static class EnventContinueVip {
        public static String toContinue;
    }

    //首页通知页面播放VIP视频
    public static class EnventToPlay {
        public static String toPlay;
    }
    //退出
    public static class EnventExit {
        public static String toExit;
    }
    //登录成功的通知
    public static class EnventLoginInfo {
        public static String toLoginInfo;
    }

    //如果本身在首页界面  再次点击首页时刷新
    public static class EnventRefesh {
        public static String toRefesh;
    }
