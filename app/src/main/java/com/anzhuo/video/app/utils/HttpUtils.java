...
//            client.networkInterceptors().add(new StethoInterceptor());
     ...
     * @param resultCallback
     */
    public static void uploadFileTimeOut(String url, String fileName, File file, HashMap<String, String> params, StringCallback resultCallback) {
        if (XUtilNet.isNetConnected()) {
            OkHttpUtils.post()
                    .addFile("mFile", fileName, file)//
                    .url(url)
                    .params(params)//
                    .build().connTimeOut(60_000).writeTimeOut(60_000).readTimeOut(60_000)
                    .execute(resultCallback);
        }
    }
